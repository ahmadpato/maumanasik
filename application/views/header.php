...
<head>
  ...
  <!--Title -->
  <title>Maumanasik | Pesan Pembimbing Haji Privat</title>

  <!--Basic SEO -->
  <meta name="description" content="Pembimbing haji.">
  <meta name="keywords" content="manasik haji, pembimbing haji">
      ...
      <div class="container-fluid">
        <div class="site-nav-wrapper">
          <div class="navbar-header">
            ...
            <span id="mobile-nav-open-btn" style="color: #1BAA69;">&#9776;</span>
            <!--Logo -->
            <a class="navbar-brand" href="/">
              <img class="logo-non-text" src="<?php echo base_url('img/logo/logo_manasik_hijau.png') ?>" alt="logo" width="auto" class="img-responsive" height="50px" style="margin-top: -10px;margin-left: 72px;">
            </a>
            <!--Logo -->
            <a class="navbar-brand-mobile" href="/">
              <img src="<?php echo base_url('img/logo/logo_manasik_hijau.png') ?>" alt="maungaji" border="0" class="img-responsive">
            </a>
          </div>
