            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <p>
                        <h3 class="text-header">Raih Kemabruran Haji</h3>
                        </p>
                        <p>
                        ...
                        <br>
                        <p>
                        <h4 style="color: #FFF; line-height: normal;">Dengan Pembimbing Haji yang sudah Bersertifikat  <span style="color: #FFE604"></span>  <span style="color: #FFE604"></span>
                        </h4>
                        </p>
                        <br>
    ...
    <div class="gtco-testimonials study-packages">
        ...
        <div class="owl-carousel owl-carousel1 owl-theme" style="margin-top: -50px;">
            ...
            <div class="card text-center package-card <?php echo $container_class_kelompok; ?> ">
             ...
             <div class="card text-center package-card" style="background: #3597d4;">
                <img class="card-img-top" src="<?php echo base_url('img/icon/new/keluarga.svg') ?>" alt="">
                <div class="card-body">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12">
                        <p>
                        <h3 style="font-family: 'Poppins'; font-weight: 1000; font-size: 30px;">Kelebihan Mau Manasik</h3>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 text-center square-kelebihan-maungaji" style="color:#FFFFFF; font-size:25px; font-family:Poppins;">
                        ...
                        <p style="color:#FFFFFF; font-size:25px; font-family:Poppins;">
                           Pembimbing Bersetifikat BAN-PT dan Kemenag
    ...
    <!--article-->
    <div class="gtco-article" style="margin-top: 50px">
        <div class="container">
            <div class="row">
                <div class="about-item text-left">
                    <div id="tech-statement">
